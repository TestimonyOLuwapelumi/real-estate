...
<div class="flex justify-center items-center">
  <div class="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
    <div role="main" class="flex flex-col items-center justify-center">
      <h1 class="text-4xl font-semibold leading-9 text-center text-gray-800  text-gray-50">This Week Blogs</h1>
      <p class="text-base leading-normal text-center text-gray-600  text-white mt-4 lg:w-1/2 md:w-10/12 w-11/12">If you're looking for random paragraphs, you've come to the right place. When a random word or a random sentence isn't quite enough</p>
    </div>
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl  text-white">Our Executive Team</h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                ...
                {team.map((val, index) => (
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600  border-gray-700  hover:border-transparent">
                {/* <img class=" h-32 w-32 rounded-full "    style={{backgroundImage: `url(${val.cover})`}} alt=""/> */}
                <img alt="" className="self-center flex-shrink-0 w-32 h-32 bg-center bg-cover rounded-full  bg-gray-500" src={val.cover} />

                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  text-white group-hover:text-white">{val.name}</h1>

                <p class="mt-2 text-gray-500 capitalize  text-gray-300 group-hover:text-gray-300"><i className='fa fa-location-dot'></i> {val.address}</p>
